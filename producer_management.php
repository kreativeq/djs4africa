...
<div class="container_12">
    ...
    <section class="grid_7">
      ...
      <span style="font-size:18px; font-weight:700; color:#999;">DJs For Africa Producer & Writer Management//</span>
   
        <br />
   
        <hr />
          <p>Djs For Africa Producer & Writer Management is a specific department of the group setup in 2009 to represent the Songwriting and Production activities of our entire roster.</p>
         <hr />
     
     <img src="sources/images/newbanner.png" />
        

<p>
<h3>Producers & Writers//</h3>
DJ Satelite<br />
DJ X Trio<br />
DJ Prynctn Prince<br />
Jackie Queens<br />
Ayanda Aylo<br />
TP Twini<br />
Stélio Scad Douglas<br />
Dyce Jones<br />
Luke Gray<br />
Tikolo Toshi<br />
Blaque Soul<br />
