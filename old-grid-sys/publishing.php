...
<div class="container_12">
    ...
    <section class="grid_7">
      ...
      <span style="font-size:18px; font-weight:700; color:#999;">DJs For Africa Music Publishing//</span>
            
            <br />
            
        <hr />
          <p>DJs For Africa Publishing is a division of the company that enables us to offer full publishing facilities to artists managed under the umbrella of the group.</p>
         <hr />
     
     <img src="sources/images/publisher_banner.png" />
     
<p id="left_para">DJs For Africa Publishing is a division of the company that enables us to offer full publishing facilities to artists managed under the umbrella of the group.</p>
         
<p id="ryt_para">This offers an in-house controlled service while having the benefit of being able to use the infrastructure of a major publishing company.</p>
      </aside>
